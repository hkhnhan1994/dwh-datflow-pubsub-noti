...
from .transformations import  write_to_BQ, read_path_from_pubsub, avro_schema, read_avro_content
...
def run(beam_options):
    with beam.Pipeline(options=beam_options) as p:
        ...
        read_data = (
            read_file_path
            |read_avro_content(cdc_ignore_fields)
